...
import INTEGER Texts_Pos (Texts_Reader *R, LONGINT *R__typ);
...
import void Texts_SetColor (Texts_Writer *W, LONGINT *W__typ, BYTE col);
import void Texts_SetFont (Texts_Writer *W, LONGINT *W__typ, Texts_FontsFont fnt);
import void Texts_SetOffset (Texts_Writer *W, LONGINT *W__typ, BYTE voff);
...
import void Texts_WriteDate (Texts_Writer *W, LONGINT *W__typ, INTEGER t, INTEGER d);
import void Texts_WriteElem (Texts_Writer *W, LONGINT *W__typ, Texts_Elem e);
import void Texts_WriteHex (Texts_Writer *W, LONGINT *W__typ, INTEGER x);
import void Texts_WriteInt (Texts_Writer *W, LONGINT *W__typ, INTEGER x, INTEGER n);
import void Texts_WriteLn (Texts_Writer *W, LONGINT *W__typ);
import void Texts_WriteLongHex (Texts_Writer *W, LONGINT *W__typ, LONGINT x);
import void Texts_WriteLongInt (Texts_Writer *W, LONGINT *W__typ, LONGINT x, INTEGER n);
import void Texts_WriteLongReal (Texts_Writer *W, LONGINT *W__typ, LONGREAL x, SHORTINT n);
