...
__TDESC(CmdlnTexts_FileMsg__desc, 1, 1) = {__TDFLDS("FileMsg", 40), {24, -16}};
...
__TDESC(CmdlnTexts_Reader__desc, 1, 4) = {__TDFLDS("Reader", 80), {8, 24, 40, 56, -40}};
__TDESC(CmdlnTexts_Scanner__desc, 1, 4) = {__TDFLDS("Scanner", 192), {8, 24, 40, 56, -40}};
__TDESC(CmdlnTexts_Writer__desc, 1, 4) = {__TDFLDS("Writer", 56), {0, 8, 32, 48, -40}};
