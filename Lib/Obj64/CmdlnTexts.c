...
__TDESC(CmdlnTexts_FontDesc__desc, 1, 0) = {__TDFLDS("FontDesc", 32), {-8}};
__TDESC(CmdlnTexts_RunDesc__desc, 1, 3) = {__TDFLDS("RunDesc", 40), {0, 8, 24, -32}};
__TDESC(CmdlnTexts_PieceDesc__desc, 1, 4) = {__TDFLDS("PieceDesc", 56), {0, 8, 24, 40, -40}};
__TDESC(CmdlnTexts_ElemMsg__desc, 1, 0) = {__TDFLDS("ElemMsg", 1), {-8}};
__TDESC(CmdlnTexts_ElemDesc__desc, 1, 4) = {__TDFLDS("ElemDesc", 72), {0, 8, 24, 64, -40}};
__TDESC(CmdlnTexts_FileMsg__desc, 1, 1) = {__TDFLDS("FileMsg", 56), {32, -16}};
__TDESC(CmdlnTexts_CopyMsg__desc, 1, 1) = {__TDFLDS("CopyMsg", 8), {0, -16}};
__TDESC(CmdlnTexts_IdentifyMsg__desc, 1, 0) = {__TDFLDS("IdentifyMsg", 64), {-8}};
__TDESC(CmdlnTexts_BufDesc__desc, 1, 1) = {__TDFLDS("BufDesc", 16), {8, -16}};
__TDESC(CmdlnTexts_TextDesc__desc, 1, 2) = {__TDFLDS("TextDesc", 32), {8, 16, -24}};
__TDESC(CmdlnTexts_Reader__desc, 1, 4) = {__TDFLDS("Reader", 96), {8, 24, 48, 72, -40}};
__TDESC(CmdlnTexts_Scanner__desc, 1, 4) = {__TDFLDS("Scanner", 208), {8, 24, 48, 72, -40}};
__TDESC(CmdlnTexts_Writer__desc, 1, 4) = {__TDFLDS("Writer", 72), {0, 8, 40, 64, -40}};
__TDESC(CmdlnTexts__1__desc, 1, 5) = {__TDFLDS("", 160), {0, 8, 24, 64, 72, -48}};
