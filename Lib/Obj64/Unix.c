...
__TDESC(Unix_Rusage__desc, 1, 0) = {__TDFLDS("Rusage", 128), {-8}};
__TDESC(Unix_Iovec__desc, 1, 0) = {__TDFLDS("Iovec", 16), {-8}};
__TDESC(Unix_Pollfd__desc, 1, 0) = {__TDFLDS("Pollfd", 16), {-8}};
__TDESC(Unix_Sockaddr__desc, 1, 0) = {__TDFLDS("Sockaddr", 16), {-8}};
__TDESC(Unix_Hostent__desc, 1, 0) = {__TDFLDS("Hostent", 32), {-8}};
