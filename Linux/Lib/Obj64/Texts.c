...
__TDESC(Texts_Reader__desc, 1, 4) = {__TDFLDS("Reader", 80), {8, 24, 40, 64, -40}};
__TDESC(Texts_Scanner__desc, 1, 4) = {__TDFLDS("Scanner", 176), {8, 24, 40, 64, -40}};
__TDESC(Texts_Writer__desc, 1, 4) = {__TDFLDS("Writer", 64), {0, 8, 32, 56, -40}};
