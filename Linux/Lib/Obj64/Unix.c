...
LONGINT Unix_Stat (CHAR *name, LONGINT name__len, Unix_Status *statbuf, LONGINT *statbuf__typ)
{
	...
	(*statbuf).dev += (*statbuf).devX;
	(*statbuf).rdev += (*statbuf).rdevX;
	__DEL(name);
	return res;
}
...
__TDESC(Unix_JmpBuf__desc, 1, 0) = {__TDFLDS("JmpBuf", 312), {-8}};
__TDESC(Unix_Status__desc, 1, 0) = {__TDFLDS("Status", 144), {-8}};
__TDESC(Unix_Timeval__desc, 1, 0) = {__TDFLDS("Timeval", 16), {-8}};
__TDESC(Unix_Timezone__desc, 1, 0) = {__TDFLDS("Timezone", 16), {-8}};
__TDESC(Unix_Itimerval__desc, 1, 0) = {__TDFLDS("Itimerval", 32), {-8}};
__TDESC(Unix_SigContext__desc, 1, 0) = {__TDFLDS("SigContext", 1), {-8}};
__TDESC(Unix_Dirent__desc, 1, 0) = {__TDFLDS("Dirent", 280), {-8}};
__TDESC(Unix_Rusage__desc, 1, 0) = {__TDFLDS("Rusage", 144), {-8}};
__TDESC(Unix_Iovec__desc, 1, 0) = {__TDFLDS("Iovec", 16), {-8}};
__TDESC(Unix_Pollfd__desc, 1, 0) = {__TDFLDS("Pollfd", 16), {-8}};
__TDESC(Unix_Sockaddr__desc, 1, 0) = {__TDFLDS("Sockaddr", 24), {-8}};
__TDESC(Unix_Hostent__desc, 1, 0) = {__TDFLDS("Hostent", 40), {-8}};
