...
static void EnumPtrs(void (*P)(void*))
{
	...
	P(OfrontOPT_syslink);
	__ENUMR(&OfrontOPT_impCtxt, OfrontOPT_ImpCtxt__typ, 3140, 1, P);
}

__TDESC(OfrontOPT_ConstDesc__desc, 1, 1) = {__TDFLDS("ConstDesc", 24), {0, -8}};
__TDESC(OfrontOPT_ObjDesc__desc, 1, 6) = {__TDFLDS("ObjDesc", 80), {0, 4, 8, 12, 60, 64, -28}};
__TDESC(OfrontOPT_StrDesc__desc, 1, 3) = {__TDFLDS("StrDesc", 56), {44, 48, 52, -16}};
__TDESC(OfrontOPT_NodeDesc__desc, 1, 6) = {__TDFLDS("NodeDesc", 28), {0, 4, 8, 16, 20, 24, -28}};
__TDESC(OfrontOPT_ImpCtxt__desc, 1, 510) = {__TDFLDS("ImpCtxt", 3140), {16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 
