...
TYPE
  CHAR = s.CHAR8; SHORTINT = s.INT8; INTEGER = s.INT16; LONGINT = s.INT32;
...
PROCEDURE Length*(IN t:StringT):LONGINT;
...
PROCEDURE Pos*(IN pattern:StringT; 
               IN t:StringT; 
...
PROCEDURE Copy*(IN source:StringT; VAR dest:StringT; 
...
PROCEDURE Append*(VAR dest:StringT; IN src:StringT);
...
PROCEDURE Insert*(IN source:StringT; VAR dest:StringT; pos:LONGINT);
