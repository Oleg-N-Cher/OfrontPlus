...
(* UNIX
	...
	MixerLibName = "libSDL_mixer-1.2.so.0";
*)

  (* Printable format: "%d.%d.%d", MAJOR, MINOR, PATCHLEVEL *)
  MIXER_MAJOR_VERSION* = 1;
...
*)
  (* Mix_Fading *)
  MIX_NO_FADING* = 0; MIX_FADING_OUT* = 1; MIX_FADING_IN* = 2;
  (* Mix_MusicType *)
  MUS_NONE* = 0;
  MUS_CMD* = 1;
  MUS_WAV* = 2;
...
*)
  ...
  PMix_Chunk* = POINTER[1] TO Mix_Chunk;
  Mix_Chunk* = RECORD[1]
    allocated* : Integer;
    abuf* : PUInt8;
    alen* : UInt32;
  ...
  Mix_Fading = Byte; (* MIX_NO_FADING, MIX_FADING_OUT, MIX_FADING_IN *)
  Mix_MusicType = Byte;
  (* MUS_NONE, MUS_CMD, MUS_WAV, MUS_MOD, MUS_MID, MUS_OGG, MUS_MP3,
     MUS_MP3_MAD, MUS_FLAC, MUS_MODPLUG *)
...
*)
  ...
  PMix_Music* = POINTER[1] TO Mix_Music;
  Mix_Music* = RECORD[1]
    type* : Mix_MusicType;
    data* : MusicUnion;
    fading* : Mix_Fading;
