MODULE [foreign] bbLinLibW;
	...
	*)
	...
	PROCEDURE- iswalpha* (wc: wint_t): int "iswalpha((unsigned int)wc)";
	PROCEDURE- iswlower* (wc: wint_t): int "iswlower((unsigned int)wc)";
	PROCEDURE- iswupper* (wc: wint_t): int "iswupper((unsigned int)wc)";
	PROCEDURE- towlower* (wc: wint_t): wint_t "towlower((unsigned int)wc)";
	PROCEDURE- towupper* (wc: wint_t): wint_t "towupper((unsigned int)wc)";
