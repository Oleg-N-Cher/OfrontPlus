...
%CC% OCatCmd.c %lib% -o..\Bin\ocat.exe
IF errorlevel 1 PAUSE
EXIT

:Ofront
IF NOT "%1"=="OfrontCmd" GOTO Watson
%CC% OfrontCmd.c OfrontErrors.c OfrontOPM.c OfrontOPS.c OfrontOPT.c OfrontOPB.c OfrontOPP.c OfrontOPC.c OfrontOPV.c %lib% -o..\Bin\ofront+.exe
IF errorlevel 1 PAUSE
EXIT

:Watson
IF NOT "%1"=="WatsonCmd" GOTO BuildAll
%CC% Watson0.c WatsonCmd.c OfrontErrors.c OfrontOPM.c OfrontOPS.c OfrontOPT.c OfrontOPC.c OfrontOPV.c %lib% -o..\Bin\watson.exe
IF errorlevel 1 PAUSE
EXIT
...
%CC% OfrontCmd.c OfrontErrors.c OfrontOPM.c OfrontOPS.c OfrontOPT.c OfrontOPB.c OfrontOPP.c OfrontOPC.c OfrontOPV.c %lib% -o..\Bin\ofront+.exe
IF errorlevel 1 PAUSE
::%CC% Watson0.c WatsonCmd.c OfrontErrors.o OfrontOPM.o OfrontOPS.o OfrontOPT.o OfrontOPC.o OfrontOPV.o %lib% -o..\Bin\watson.exe
::IF errorlevel 1 PAUSE
