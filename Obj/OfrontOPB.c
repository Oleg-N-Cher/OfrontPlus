...
static LONGINT OfrontOPB_maxExp;
	...
	switch (op) {
		case 1: 
			if (__IN(f, 0x70)) {
				...
				if (temp || __ABS(xval->realval) <= 1.797692955093002E+308 / (LONGREAL)__ABS(yval->realval)) {
		...
		case 2: 
			if (__IN(f, 0x70)) {
				...
				temp = __ABS(yval->realval) >= (LONGREAL)1;
				if (temp || __ABS(xval->realval) <= 1.797692955093002E+308 * __ABS(yval->realval)) {
					xval->realval = xval->realval / yval->realval;
		...
		case 6: 
			if (__IN(f, 0x70)) {
				...
				temp = yval->realval >= (LONGREAL)0 && xval->realval <= 1.797692955093002E+308 - yval->realval;
				if (temp || yval->realval < (LONGREAL)0 && xval->realval >= -1.797692955093002E+308 - yval->realval) {
					xval->realval = xval->realval + yval->realval;
		...
		case 19: 
			if (x->class == 8 || x->class == 9) {
				...
				if (p->class == 7 && x->class == 7) {
					if (-OfrontOPB_maxExp > x->conval->intval || x->conval->intval > OfrontOPB_maxExp) {
						OfrontOPB_err(208);
						p->conval->intval = 1;
...
/* BEGIN */
	OfrontOPB_maxExp = OfrontOPB_log(1073741824);
	OfrontOPB_maxExp = OfrontOPB_exp;
	__ENDMOD;
}
