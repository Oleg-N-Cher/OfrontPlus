...
ofront+ -sC -48 MyDLL.cp -d MyDLLuse.cp -m
IF errorlevel 1 PAUSE
ofront+ -mC -48 BlitBmp.cp BlitBmp2.cp Book.cp Cnezinka.cp Elo4ka.cp Gradient24.cp HelloWorld.cp Mandelbrot.cp Mandelbrot2.cp TestHttp.cp
IF errorlevel 1 PAUSE
